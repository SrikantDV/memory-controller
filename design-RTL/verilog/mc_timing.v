...
//  CVS Log
//
//  $Id: mc_timing.v,v 1.1 2007/07/16 06:44:33 sreddy Exp $
//
//  $Date: 2007/07/16 06:44:33 $
//  $Revision: 1.1 $
//  $Author: sreddy $
//  $Locker:  $
//  $State: Exp $
...
// Change History:
//               $Log: mc_timing.v,v $
//               Revision 1.1  2007/07/16 06:44:33  sreddy
//               Initial version
//
...
//                   6666666555555555544444444443333333333222222222211111111110000000000
//                   6543210987654321098765432109876543210987654321098765432109876543210
INIT0		= 66'b0000000000000000000000000000000000000000000010_0000_0000_0000_0000_0000,  
...
INIT_REFR1	= 66'b000000000000000000000000000000000000000001_0000_0000_0000_0000_0000_0000,
INIT_REFR1_W	= 66'b000000000000000000000000000000000000000010000000000000000000000000,
//                   6666666555555555544444444443333333333222222222211111111110000000000
//                   6543210987654321098765432109876543210987654321098765432109876543210
INIT_LMR	= 66'b00000000000000000000000000000000000000_0100_0000_0000_0000_0000_0000_0000,
...
`endif
	   IDLE:
		...
		if(cs_a & (wb_read_go | wb_write_go) & lookup_ready2) begin
		   wb_cycle_set = 1'b1;
